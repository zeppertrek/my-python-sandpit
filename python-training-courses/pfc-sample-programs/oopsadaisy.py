...
class Simplesimon5:
    ...
    # __ - dunder method
    def __repr__(self):
        return "NameX - {}, AgeX - {}, GenderX - {}, Birthplace - {}".format ( self.name, self.age, self.gender, self.birthplace)
...
print ("__str__ is being called here -   ", guy105 )

print ("__repr__ is being called here -   ", repr(guy105) )
